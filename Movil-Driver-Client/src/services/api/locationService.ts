...
export class LocationService {
   ...
   * ✅ MEJORADO: Ahora funciona con o sin routeId asignado
   */
  static publishLocationData(
    ...
    try {
      ...
      // ✅ NUEVO: Generar topic dinámico - con routeId o fallback
      let topic: string;
      ...
      if (routeId) {
        ...
        // ✅ NUEVO: Sin ruta asignada - usar topic por vehículo y conductor
      ...
      const message = {
        ...
        source: 'MOVILE',
        // ✅ NUEVO: Marcar explícitamente que no hay ruta asignada

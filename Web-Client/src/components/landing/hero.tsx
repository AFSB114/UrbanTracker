        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground text-balance mb-8">
              Sistema de gestión y visualización de rutas de transporte público
              en tiempo real
            </p>
          </div>

          {/* Botones */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 z-50">
            <Button
              size="lg"
